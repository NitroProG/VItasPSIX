...
insert into defender(DefenderKey)
	values('LuJBX4xWsrNyDvIXEAWaHRp85T+sGzAdeMJygolTZ+o=');
go
...
INSERT into dbo.users(User_Login,User_Password,User_Mail,UserStatus,Teacher_id)
	Values ('admin','NxVLJsuOKPpSAHVofcDAGg==','U72BzO/zyzLZQRw2Kfdwnixn4CmutIJm8+mrqLbsR/c=',0,1);
INSERT into dbo.users(User_Login,User_Password,User_Mail,UserStatus,Teacher_id)
	Values ('test','VNWiwdLsl3kMzbtP+2Ol1Q==','cKtVRuknSvYAmSzDR6u7CtAA20MzIlAjDuXSRogAVUU=',0,2);
INSERT into dbo.users(User_Login,User_Password,User_Mail,UserStatus,Teacher_id)
	Values ('student','i7SS5R9fubq9FVFEQVtIpg==','U72BzO/zyzLZQRw2Kfdwnixn4CmutIJm8+mrqLbsR/c=',0,2);
go
...
insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от матери: "У Сергея нет друзей.  Объясните в чем причина."',N'Сергей - 15 лет, 9 класс.',N'	Маме:
...
возможно, оно будет Сергею тоже интересно.',N'	Психологом была проведена беседа с мамой и подростком, в которой были объяснены характерологические и темпераментальные 
особенности Сергея. Отдельно с мамой были проведены три консультативные сессии с целью осознания нарушения стиля семейного воспитания и его коррекции. Результатом такой работы стало то, что 
Сергей подружился с парнем из класса, вместе они ездили на подготовительные курсы. Он реализовал свою мечту и поступил в Тимирязевскую академию. Среди студентов у него также появился друг. 
Ребята общаются с девушками из группы.
	Мать перешла на другую работу. Стала редко бывать дома. Сергей также помогает ей по дому. Но теперь уже и младший сын разделяет с ним домашние обязанности.');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от матери: "Очень разборчив в еде. Ест плохо. Не поймёшь в каком настроении находится. В чем дело?"',N'Дима - 14 лет, 8 класс.',N'	Маме:
...
самостоятельно или с помощью психолога.',N'	Психологом была проведена беседа с мамой и подростком, в которой были отмечены характерологические особенности Димы, а также
...
что живут далеко друг от друга.');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от отца: «Сын способный, но постоянно учится на «четвертки» по всем предметам».',N'Дима - 14 лет, 8 класс.',N'	Маме:
...
следующим пунктам: предмет; время выполнения; конспект; пересказ.',N'    Психологом была проведена беседа с мамой и Димой, в которой были разъяснены особенности заострения черт характера, причины их формирования и их проявление в жизни подростка. Были даны 
рекомендации маме и сыну. С Димой были проведены развивающие занятия по коррекции логических связей и операций мышления "аналогии", "классификации" и "обобщения", разработанной к методике ШТУР.
	...
	Дима начал заниматься в секции баскетболом и стал помогать своему  классному руководителю по обустройству класса.');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от матери: "Юра ворует крупные суммы денег. Учится очень плохо. Что мне делать?"',N'Юра - 14 лет.',N'	Маме:
...
внимательно читать учебник и учить определения.
6. Постараться ликвидировать пробелы в 
знаниях.
7. При желании совершить какой-либо 
асоциальный поступок постараться подумать о 
дальнейших последствиях и "остановить" себя.',N'    Психологом была проведена беседа с мамой и подростком, в которой были разъяснены причины поведения и особенности характера подростка. Были даны рекомендации маме и сыну.
...
Она отметила, что Юра перестал брать деньги из дома. Компьютерные клубы он в последнее время также перестал посещать.
	Также она отмечает, что часто они стали разговаривать вечерами с сыном и обсуждать произошедшие за день события.');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от классного руководителя : "Сделайте что-нибудь с этим учеником, он неуправляем."',N'Денис - 15 лет, 9 класс.',N'    Классному руководителю:
...
пробовать осознать его результат.',N'    Мама согласилась пройти с Денисом 15 сессий индивидуальной терапии. Терапия была направлена на осознание неправильного стиля семейного воспитания, нарушение взаимоотношений в семье и восстановление эмоциональных отношений между матерью и сыном. В 
...
влияло положительно на поведение Дениса.');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от мамы: "Очень переживает свои неудачи и удачи брата. Объясните, почему?"',N'Иван - 7 лет, 1 класс.',N'    Родителям
...
3.	Ребенка нужно не просто побольше хвалить и поменьше ругать, но хвалить именно тогда, когда он что-то делает, а не тогда, когда пассивно сидит, не мешая окружающим.',N'Катамнестические данные отсутствуют');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от мамы: "Чрезмерная подвижность ребенка на уроках. Объясните, в чем причина?"',N'Никита - 8 лет, 1 класс.',N'    Учителю:
...
3. Проявлять самостоятельность в выполнении домашних заданий.',N'Катамнестические данные отсутствуют');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от мамы: "Все в классе управляют Лизой. Она постоянно находится под влиянием одноклассников. Не может высказать собственной точки зрения. Почему это происходит?"',N'Лиза - 9 лет, 3 класс.',N'    Учителю:
...
3.	Больше проявлять самостоятельности в выполнении домашних заданий.',N'Катамнестические данные отсутствуют');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от учителя:"Ученик, характеризующийся с положительной стороны, начал пропускать уроки без уважительной причины. Почему это происходит?"',N'Сережа - 10 лет, 4 класс.',N'    Учителю:
...
4.	Проявлять собственное мнение и обдумывать «что можно», а «что нельзя».',N'Катамнестические данные отсутствуют');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от учителя:"Ребёнок на уроке ничего не хочет делать или занимается тем, чем ему хочется(чтение книг, рисование). Почему так происходит?"',N'Влад - 10 лет, 4 класс.',N'    Учителю:
...
4.	Активно участвовать в жизни класса.',N'Катамнестические данные отсутствуют');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от классного руководителя:"Имеются страхи в отношениях с учителями, как с ними бороться?"',N'Влада – 14 лет, 7 класс.',N'    Штатному школьному психологу:
...
Развивать концентрацию и избирательность внимания, попробовать сосредоточиться на какой-нибудь деятельности (учебный предмет) и заниматься им в течение 40-45 мин, не отрываясь. ',N'    По истечению почти годового срока поведение Бори улучшилось лишь слегка. В целом, скорее учителя привыкли к его личности и уже стараются не замечать его выкрутасов, когда это не нарушает учебный процесс. Это часто приводит к тому, что он перестает проявлять демонстративное и капризное поведение. В целом, основная сложность в работе с Борей заключается в том, что его семья (мама и папа) абсолютно не находят времени для посещения школьного психолога. А ведь одна из причин плохого поведения Бори именно в попустительском типе воспитания. Из-за такого отношения и сам Боря практически не посещает психологические сессии.');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от классного руководителя:"Саша проявляет страхи в отношениях с учителями, необходимо помочь ей их преодолеть."',N'Александра - 15 лет, 8 класс.',N'    Штатному школьному психологу:
...
Твои высокоразвитые моральные качества также заставляют острее переживать ситуации, в которых Ты сама виновата. Всегда помни, что это хорошо, это значит, что у Тебя есть совесть и честь – пусть эта мысль всегда Тебя «греет» в подобных ситуациях.',N'    В результате консультационной работы по рекомендациям с Сашей, примерно за полгода (по одной консультации в неделю) удалось избавить её от тревожности по отношению ко всем учителям. Теперь, по словам Саши, она старается войти в положение самого учителя (даже если тот разговаривает грубо) и понять, что, как правило, такая грубость не связана с неприязнью к самой Саше, а просто является «необходимым элементом» профессии.');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от директора:"Не желает учится, что делать?"',N'Никита - 15 лет, 9 класс.',N'    Штатному школьному психологу:
...
Стараться отвечать честно, даже если ответ выдаст его нежелательные стороны (например, лень и т.п.). ',N'    К сожалению, в течение года Никита практически не появлялся в школе и не ходил на консультации к психологу – что сделало невозможным применение разработанных рекомендаций на практике.');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от мамы:"Не знаю, как с ним найти общий язык, его трудно застравить что-либо сделать."',N'Лев - 12 лет, 5 класс.',N'    Штатному школьному психологу:
...
Стараться в трудные моменты вспоминать что-то хорошее.',N'    В результате проведенной работы в виде консультационных сессий по рекомендациям со Львом и его Мамой удалось наладить отношения и позитивный контакт между ними. Лев до сих пор с удовольствием ходит к школьному психологу и признается, что стал чувствовать себя намного лучше. Мама Льва отмечает, что все чаще Лев ведет себя нормально и проявляет доброжелательность.');

insert into dbo.Zadacha(Zapros,sved,meroprtext,katamneztext)
	values (N'Запрос от мамы:"Хотелось бы понять, почему Саша общается только внутри референтной группы и часто отказывается от помощи даже близких людей(вплоть до вспышек агрессии)."',N'Александр - 18 лет, 2 курс техникума.',N'    Психологу:
...
Не отказываться от помощи близких, когда ситуация того требует.',N'    В результате проведения нескольких консультаций с Сашей по разъяснению ему рекомендаций он стал чаще обращать внимание на проявление своих эмоций. Сейчас он старается чаще говорить о них и проявляет их «дозировано», отчего вспышки агрессии стали проявляться гораздо реже. Самостоятельным Саша так и остается, но теперь он, иногда с удовольствием готов принять помощь от мамы. Что касается общительности, то Сашина избирательность доверия сохраняется, однако круг общения в референтной группе расширился, впустив в свои ряды нескольких новых участников.');
go
